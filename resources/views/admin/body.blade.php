              ...
              <div class="row">
                <div class="col-9">
                  <div class="d-flex align-items-center align-self-start">
                    ...
                    <p class="text-success ml-2 mb-0 font-weight-medium">Product</p>
                  </div>
                </div>
                <div class="col-3">
              ...
              <div class="row">
                <div class="col-9">
                  <div class="d-flex align-items-center align-self-start">
                    ...
                    <p class="text-danger ml-2 mb-0 font-weight-medium">users</p>
                  </div>
                </div>
                <div class="col-3">
              ...
              <div class="row">
                <div class="col-9">
                  <div class="d-flex align-items-center align-self-start">
                    ...
                    <p class="text-success ml-2 mb-0 font-weight-medium">revenue</p>
                  </div>
                </div>
                <div class="col-3">
                  <div class="icon icon-box-success ">
              ...
              <div class="row">
                <div class="col-9">
                  <div class="d-flex align-items-center align-self-start">
                    ...
                    <p class="text-success ml-2 mb-0 font-weight-medium">Item delivered</p>
                  </div>
                </div>
                <div class="col-3">
                  <div class="icon icon-box-success ">
              ...
              <div class="row">
                <div class="col-9">
                  <div class="d-flex align-items-center align-self-start">
                    <h3 class="mb-0">{{
                      $total_processing }}</h3>
                    <p class="text-success ml-2 mb-0 font-weight-medium">Item are processing</p>
                  </div>
                </div>
                <div class="col-3">
                  <div class="icon icon-box-success ">
