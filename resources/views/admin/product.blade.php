  ...
  <body>
    <div class="container-scroller">
     ...
     <div class="div_design">
        ...
        <input class="text_color" type="text" name="description" placeholder="Write Description Here" required>
     </div>
     ...
     <div class="div_design">
        ...
        <input class="text_color" type="text" name="dis_price" placeholder="Write a discount is applied">
     </div>
